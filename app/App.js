...
import FireSyncAuthScreen from "./src/screens/FireSyncAuthScreen";
...
function AppContent() {
    ...
    React.useEffect(() => {
        if (!isDbReady) return;
        const onboardingDone = getSetting("onboarding_complete") === "true";
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName={initialRoute}>
                ...
                <Stack.Screen
                    name="FireSyncAuth"
                    component={FireSyncAuthScreen}
                    options={{ title: "FireSync", ...HEADER_OPTS }}
                />
            </Stack.Navigator>
        </NavigationContainer>
    );
